...
def main():
    ...
    print('\n')
    while True:
        print("Use the following code to signup: su - SignUp, nw - Add New Account, da - Display Accounts, vw -View Account Details, dl - Delete Account Detaiils")
        ...
        if user_choice == "su":
            ...
            print('\n')
            print(f"New user {login_userName} has been created.You can now proceed to login with your credentials.")
            print('\n')
        # elif user_choice == "lg":
